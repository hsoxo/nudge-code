...
- The scaffold includes machine list, tab strip, terminal preview WebView, phone/computer width control, pairing URL parsing, pending binding UI, Keychain-backed phone signing identity, a first-pass relay claim client, and adaptive shortcut keyboard model/tests for Claude/Codex approval/waiting states.
- Camera QR scanning, websocket sync, protobuf Swift generation, xterm.js assets, signed auth, and E2E encryption remain open.
