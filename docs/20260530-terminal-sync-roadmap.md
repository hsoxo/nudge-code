...
- **Date:** 2026-05-30
- **Status:** Phases 0–2 shipped + reviewed CLEAN; Phase 3 (3.1/3.2) shipped; Phase 4 (4.2 buffers incl. JS ring, 4.3 focused-tab) shipped, 4.1 binary-frames **blocked** (relay not in this repo); Phase 5 spike done (2026-05-31)
- **Progress:**
